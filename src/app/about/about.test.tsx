...
describe("About Component", () => {
  test("renders the title, paragraphs, and link correctly", () => {
    ...
    expect(
      screen.getByText(/Bem-vindo ao Pokémon Go Tier List!/i)
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Seja você um jogador novato ou experiente/i)
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Este é um projeto de código aberto/i)
    ).toBeInTheDocument();
